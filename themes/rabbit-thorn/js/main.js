( function( $ ) {
    ...
    THE_TATTOOIST.instagram = {
        ...
        getPicsUrls : function(){
            ...
            $.ajax({
                url: "https://www.instagram.com/rabbitandthorn/?__a=1",
            }).done(function(result) {
                const $result = (result.graphql.user.edge_owner_to_timeline_media.edges)
                const $pic_urls = $result.map(val => val.node.display_url)

                objs.cacheResult = $pic_urls;
                // create pics
